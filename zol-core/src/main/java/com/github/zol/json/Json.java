...
/**
 * Copied from here: https://github.com/bolerio/mjson
 *
 * <p>
...
//	    htmlEscapeSet.add('/');  -- Removing slash for now since it causes some incompatibilities
    ...
    public static void main( String[] argv ) {
        ...
        if (json.has( "a" )) {
            System.out.println("b at a " + json.at( "b" ));
            System.out.println("a: " +  json.at( "a" ).getValue());
        }
        System.out.println(json.toString(  ));

        if (json.isString()) {
            System.out.println("String: " + json.getValue());
        }
